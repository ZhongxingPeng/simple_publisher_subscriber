...
int main(int argc, char** argv) {
  ...
  // Create and publish a new message to triger the cross publishing between the
  // threads of ModuleA and ModuleB. More details can be referred to the
  // methods of "run()" in ModuleA and ModuleB.
  //
  // Since in "run()", ModuleA waitting for 1 sec but ModuleB waitting for 2 sec
  // During a same time peorid, threads of ModuleA will have two times of msg
  // than those of ModuleB.
  ...
  // Nothing, but "Unsubscribe: No such topic called" will show in your terminal
