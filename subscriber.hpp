...
#ifndef _SUBSCRIBER_H_  // NOLINT(build/header_guard)
...
class Subscriber;  // forward reference


// Class Topic: maintains a vector of pointers to the threads subscribed to this
// topic
class Topic {
 public:
    ...
    // Return a vector contains all threads subscribed to this topic
...
// Class MatchString is unary function, which will be used together with find_if
// in MessageServer::checkTopicStatus() to find an object from a vector,
// according to the object's certain attribute
class MatchString {
 public:
...
class Subscriber {
 ...
 private:
    // Msssage buffer: a vector of Message objects
